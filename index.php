...
if(!isset($_SERVER['PHP_AUTH_PW'])) {
    ...
    printZPushLegal("Access denied. Please send authorization information");
...
include_once(BASE_PATH . "/backend/mocks/mockbackend.php");

debugLog("Load our backend driver");
debugLog($BACKEND_PROVIDER);
